...
class MyConnection {
    ...
    public String Validate_User (String DOB , @NotNull HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        createConnection();
        String result = "No User Found" ;
        try {
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
            java.util.Date utilDate = dateFormat.parse(DOB); // Parse as java.util.Date
            java.sql.Date sqlDate = new java.sql.Date(utilDate.getTime());
            Statement statement = connection.createStatement();
            ResultSet resultSet = statement.executeQuery("SELECT * FROM User_Authentication WHERE DOB = '" + sqlDate +  "'");
...
@WebServlet(urlPatterns = "/Validate_DOB")
public class DOBAuthentication extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String result = connectionobj.Validate_User(dobString, req, resp);
        ...
        out.println("<title>DOB Validator</title>");
        out.println("<style>");
        ...
        out.println("<form action='Validate_DOB' method='post'>");
        out.println("<input type='date' name='dob' required>");
